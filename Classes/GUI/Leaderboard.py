...
from Assets.colors import DARK_GREY, REST_BTN_COLOR, HOVER_BTN_COLOR, WARN_RED, HIDDEN_BLUE
...
class Leaderboard:
    ...
    def refresh(self) -> None:
        ...
        with open(path.join("Data", "times.timmy"), 'w') as file:
