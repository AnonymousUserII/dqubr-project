...
BLUE: pygame.Color = pygame.Color(0x26, 0x50, 0xF8)
GREEN: pygame.Color = pygame.Color(0x10, 0x96, 0x0E)
ORANGE: pygame.Color = pygame.Color(0xFF, 0x8F, 0x0F)
RED: pygame.Color = pygame.Color(0xFA, 0x3D, 0x3D)
YELLOW: pygame.Color = pygame.Color(0xF9, 0xFB, 0x39)
